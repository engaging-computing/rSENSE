== iSENSE Project Site
iSENSE[https://isenseproject.org] is an online system that promotes collaborative scientific analysis by
...
<b>Status:</b> {<img src="https://circleci.com/gh/isenseDev/rSENSE/tree/master.svg?style=shield" />}[https://circleci.com/gh/isenseDev/rSENSE] {<img src="https://copilot.blackducksoftware.com/github/repos/isenseDev/rSENSE/branches/add-security-scan/badge-risk.svg" alt="Black Duck Security Risk">}[https://copilot.blackducksoftware.com/github/repos/isenseDev/rSENSE/branches/add-security-scan]
...
The server's hostname must be set to the correct fully qualified
domain name for AJAX elements of the site to function.
