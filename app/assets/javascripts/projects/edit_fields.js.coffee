$ ->
  if namespace.controller is "projects" and namespace.action is "edit_fields"
    ...
    # Clear all hidden inputs to start
    for i in [0...5]
    ...
    ($ '#location' ).click ->
      ...
      addRow(["""<input class="input-small form-control" type="text" name="longitude" value="Longitude">""", "Longitude", "", "", """<a href="#" fid="0" class="field_delete"><i class="fa fa-close slick-delete"></i></a>"""])
      addRow(["""<input class="input-small form-control" type="text" name="latitude" value="Latitude">""", "Latitude", "", "", """<a href="#" fid="0" class="field_delete"><i class="fa fa-close slick-delete"></i></a>"""])
    ...
    ($ "#fields_table" ).on "click", ".field_delete", ->
      ...
      # fid != 0 when the field actually exists and needs to be destroyed
      if fid != "0"
