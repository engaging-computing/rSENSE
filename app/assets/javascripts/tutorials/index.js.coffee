    ...
    ($ "#tutorials_search").submit ->
      ...
      $.ajax
        ...
        success: (data, textStatus)->
          ...
          if is_admin
            addProjectButton = ($ "<div id='addProjectButton' style='text-align:center;cursor: pointer;' class='item'><img style='width:66%; height:66%' class='hoverimage' src='/assets/green_plus_icon.png'><br /><h4 style='color:#0a0;'>Create Tutorial</h4></img></div>")
