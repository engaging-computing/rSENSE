module NewsHelper
  ...
  def news_content_helper(can_edit = false)
    render 'shared/newcontent', type: 'news', field: 'content', content: @news.content, row_id: @news.id, has_content: !@news.content.blank?, can_edit: can_edit
  end
