module VisualizationsHelper
  ...
  def visualization_content_helper(can_edit = false)
      render 'shared/newcontent', {type: 'visualization', field: "content", content: @visualization.content, row_id: @visualization.id, has_content: !@visualization.content.blank?, can_edit: can_edit}
  end
