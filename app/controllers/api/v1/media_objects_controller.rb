      ...
      def saveMedia
        ...
        unless file_type == 'image'
          respond_to do |format|
            format.json { render json: { error: 'API only supports images' }, status: :unprocessable_entity }
          end
          return
        end
        ...
        if !@mo.user_id.nil? || @errors.nil?
          ...
          respond_to do |format|
            if @mo.save
              ...
              format.json { render json: { error: @mo.errors.full_messages }, status: :unprocessable_entity }
            end
          end
        else
